  ...
  void bewegen() {
    if (movePlayer == true) {
      ...
      if (x1_1 >= wWindow ) {
        speed3_1 *= -1;
        y1_1 = int(random(0, hWindow));
        speed3_1 = (0.01 * ((millis() - w.getTime()) / 1000));
      }
      ...
      if (x2_1 >= wWindow ) {
        speed3_2 *= -1;
        y2_1 = int(random(0, hWindow));
        speed3_2 = (0.01 * ((millis() - w.getTime()) / 1000));
      }
      ...
      if (x3_1 >= wWindow ) {
        speed3_3 *= -1;
        y3_1 = int(random(0, hWindow));
        speed3_3 = (0.01 * ((millis() - w.getTime()) / 1000));
      }
      ...
      if (x4_1 >= wWindow ) {
        speed3_4 *= -1;
        y4_1 = int(random(0, hWindow));
        speed3_4 = (0.01 * ((millis() - w.getTime()) / 1000));
      }
      ...
      if (x5_1 >= wWindow ) {
        speed3_5 *= -1;
        y5_1 = int(random(0, hWindow));
        speed3_5 = (0.01 * ((millis() - w.getTime()) / 1000));
      }
