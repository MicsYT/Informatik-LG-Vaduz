...
class xObstacles1Level1
{
  ...
  void bewegen() {
    if (movePlayer == true) {
      ...
      x1_1 -= speed1_1;
      if (x1_1 <= -x1_2) {
        speed1_1 = (0.1 * ((millis() - w.getTime()) / 100));
        speed1_1 *= -1;
      ...
      if (x2_1 >= wWindow ) {
        speed1_2 *= -1;
        y2_1 = int(random(0, hWindow));
        speed1_2 = (0.1 * ((millis() - w.getTime()) / 100));
      }
      ...
      if (x3_1 >= wWindow ) {
        speed1_3 *= -1;
        y3_1 = int(random(0, hWindow));
        speed1_3 = (0.1 * ((millis() - w.getTime()) / 100));
      }
      ...
      if (x4_1 >= wWindow ) {
        speed1_4 *= -1;
        y4_1 = int(random(0, hWindow));
        speed1_4 = (0.1 * ((millis() - w.getTime()) / 100));
      }
      ...
      if (x5_1 >= wWindow ) {
        speed1_5 *= -1;
        y5_1 = int(random(0, hWindow));
        speed1_5 = (0.1 * ((millis() - w.getTime()) / 100));
      }
    }
  }
  void reset()
