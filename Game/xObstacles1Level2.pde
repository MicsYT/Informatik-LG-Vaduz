...
class xObstacles1Level2
{
  ...
  void bewegen() {
    if (movePlayer == true) {
      ...
      x1_1 -= speed2_1;
      if (x1_1 <= -x1_2) {
        speed2_1 = (0.1 * ((millis() - w.getTime()) / 100));
        speed2_1 *= -1;
      ...
      if (x2_1 >= wWindow ) {
        speed2_2 *= -1;
        y2_1 = int(random(0, hWindow));
        speed2_2 = (0.1 * ((millis() - w.getTime()) / 100));
      }
      ...
      if (x3_1 >= wWindow ) {
        speed2_3 *= -1;
        y3_1 = int(random(0, hWindow));
        speed2_3 = (0.1 * ((millis() - w.getTime()) / 100));
      }
      ...
      if (x4_1 >= wWindow ) {
        speed2_4 *= -1;
        y4_1 = int(random(0, hWindow));
        speed2_4 = (0.1 * ((millis() - w.getTime()) / 100));
      }
      ...
      if (x5_1 >= wWindow ) {
        speed2_5 *= -1;
        y5_1 = int(random(0, hWindow));
        speed2_5 = (0.1 * ((millis() - w.getTime()) / 100));
      }
    }
  }
  void reset()
